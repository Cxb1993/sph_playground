...
contains
  subroutine iterate(n, sk, gamma, ptype, pos, vel, acc, &
    ...
    case(6)
      ...
      call c1(ptype, pos, mas, sk, h, den, om, cf, dcf, kcf)
      call system_clock(start)
      call periodic1v2(den, pos, 00)
      call periodic1v2(h,   pos, 00)
      call periodic1v2(om,  pos, 00)
      call system_clock(finish)
      call addTime(' bc', finish - start)
      ...
      call system_clock(start)
      call periodic1v2(prs, pos, 00)
      call periodic1v2(c,   pos, 00)
      call system_clock(finish)
      call addTime(' bc', finish - start)
      ...
      call periodic1v2(due, pos, 00)
      call periodic1v2(dh,  pos, 00)
      call system_clock(finish)
      call addTime(' bc', finish - start)
    case (7)
      ! hydroshock
