...
contains
  ...
  subroutine setup_heat_cond(dim, nx, n, sk, g, pos, vel, acc, mas, den, sln, prs, uie, cf, kcf)
  ...
  end subroutine setup_heat_cond
end module IC_heat_cond
